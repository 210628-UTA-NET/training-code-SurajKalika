using System; //Importing System namespaces(Like Packages in Java)
using HouseFunction;
/*
    Naming conventions in C#
    -We use PascalCase for most of the naming convention(Capitalizing each word)
...
namespace HelloWord
{
    class Program
    {
        //We can use underscores for private fields to refernce them easier in our code
    ...
    class Test
    {
        ...
        {
            //return keyword will tell that to return the following implementation
